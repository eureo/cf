...
class LocalizationSettingsTest < Test::Unit::TestCase
  
  include LocalizationSettings
  
  # TODO: shouldn't use production data for tests
  # require File.dirname(__FILE__) + '/../test_helper'
  TRANSLATION_TABLE = LOCALIZED_STRINGS['localization_settings']
  CONFIG[:default_language] = 'localization_settings'
